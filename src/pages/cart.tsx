...
const Cart: React.FC = () => {
  ...
  useEffect(() => {
    const total = Object.values(selectedShipping).reduce(
      (acc, price) => acc + price,
      0
    );
              ...
              <li key={index}>
                <div className="shopping-cart-card">
                  <div className="item-list-header">
                    Listings from{" "}
                    <span className="item-shopname">{item.shopName}</span>
                  </div>
                    ...
                    <table className="item-info">
                      <tbody>
                        <th className="item-info-row item-row-first">
                          <td
                            className="item-info-cell left-cell item-name"
                            colSpan={4}
                          >
                            {item.productName}
                          </td>
                          <td
                            className="item-info-cell right-cell delete-item"
                            colSpan={1}
                          >
                        ...
                        <tr className="item-info-row item-row-second">
                          <td
                            className="item-info-cell item-info-topic"
                            colSpan={4}
                          >
                            Quantity:{" "}
                            <input
              ...
              <div className="total-cart-summary">
                <div className="total-cart-content">
                  <div className="total-summary">
                    <div className="total-cell-left">Total to pay</div>
                    <div className="total-cell-right">
      ...
      <div className="suggestion-part">
        <div className="suggest-container">
          <div className="suggest-content">
            <div className="suggest-topic">You might also like</div>
            ...
            <div className="footer-right-wrapper">
              ...
              <div className="btn-screen">
                <button className="btn-desktop">
                  <img src="./icon/desktop-grey.png" />
                  Desktop
                </button>
                <button className="btn-phone">
                  <img src="./icon/phone-gr.png" />
                  Mobile
                </button>
              </div>
              <div className="copyright">© 2024 Natalie O.</div>
            </div>
          </div>
        </div>
      </div>
